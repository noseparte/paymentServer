package com.lung.controller.pay.google;
...
import com.lung.config.GoogleConfig;
import com.lung.constant.CommonConstant;
import com.lung.constant.GoodsInfoConstant;
...
import com.lung.service.pay.GoogleTranspondRecordService;
import com.lung.service.pay.RechargeRecordService;
import com.lung.util.DateUtils;
import com.lung.util.HttpUtils;
import com.lung.util.OrderGeneratedUtils;
import com.lung.util.RSASignature;
import com.lung.util.xiaomiUtil.XiaomiGoodsInfoUtil;
...
public class GooglePlayController extends BaseController {
    ...
    private static final String GOOGLE_PUBLIC_KEY = ""; // google play
